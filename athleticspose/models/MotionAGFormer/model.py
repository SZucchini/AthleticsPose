"""MotionAGFormer model from TaatiTeam/MotionAGFormer repository (Apache-2.0 License)."""
...
from athleticspose.models.MotionAGFormer.modules.attention import Attention
from athleticspose.models.MotionAGFormer.modules.graph import GCN
from athleticspose.models.MotionAGFormer.modules.mlp import MLP
from athleticspose.models.MotionAGFormer.modules.tcn import MultiScaleTCN
...
class MotionAGFormerBlock(nn.Module):
    ...
    def __init__(
        ...
        """Initialize MotionAGFormerBlock."""
        super().__init__()
    ...
    def forward(self, x):
        """Forward pass of MotionAGFormerBlock."""
...
def create_layers(
    ...
    """Generate MotionAGFormer layers."""
    layers = []
...
class MotionAGFormer(nn.Module):
    ...
    def forward(self, x, return_rep=False):
        """Forward pass of MotionAGFormer."""
