...
from athleticspose.preprocess.processing import process_hj_files
...
def main():
    ...
    output_dir = os.path.join(args.output_root, f"HJ_{args.clip_length}")
    ...
    process_hj_files(train_files, output_dir, args.clip_length, "train")
    process_hj_files(test_files, output_dir, args.clip_length, "test")
